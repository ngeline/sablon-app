            ...
            <div class="card-body py-4 px-4">
                <div class="d-flex align-items-center">
                    <div class="avatar avatar-xl">
                        <img src="<?= base_url(); ?>/admin/assets/images/faces/1.jpg" alt="Face 1" />
                    </div>
                    <div class="ms-3 name">
            ...
            <div class="card-content pb-4">
                <div class="recent-message d-flex px-4 py-3">
                    <div class="avatar avatar-lg">
                        <img src="<?= base_url(); ?>/admin/assets/images/faces/4.jpg" />
                    </div>
                    <div class="name ms-4">
                ...
                <div class="recent-message d-flex px-4 py-3">
                    <div class="avatar avatar-lg">
                        <img src="<?= base_url(); ?>/admin/assets/images/faces/5.jpg" />
                    </div>
                    <div class="name ms-4">
                ...
                <div class="recent-message d-flex px-4 py-3">
                    <div class="avatar avatar-lg">
                        <img src="<?= base_url(); ?>/admin/assets/images/faces/1.jpg" />
                    </div>
                    <div class="name ms-4">

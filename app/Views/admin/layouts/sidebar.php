    ...
    <div class="sidebar-wrapper active">
            ...
            <div class="d-flex justify-content-between align-items-center">
                <div class="logo">
                    <a href="<?= base_url('dashboard'); ?>"><img
                            src="<?= base_url(); ?>/admin/assets/images/logo/logo.svg" alt="Logo" srcset="" /></a>
                </div>
        ...
        <div class="sidebar-menu">
            <ul class="menu">
                ...
                <?php endif; ?>
                <li class="sidebar-item <?= uri_string() == 'pesanan' ? 'active' : '' ?>">
                    <a href="<?= base_url('pesanan'); ?>" class="sidebar-link">
                        <i class="bi bi-person-badge-fill"></i>

    ...
    <div class="hero_area">
        ...
        <header class="header_section">
            <div class="container">
                <nav class="navbar navbar-expand-lg custom_nav-container ">
                    <a class="navbar-brand" href="<?= base_url('/'); ?>"><img width="250" src="<?= base_url(); ?>/users/images/logo.png" alt="#" /></a>
                    ...
                    <div class="collapse navbar-collapse" id="navbarSupportedContent">
                        <ul class="navbar-nav">
                            ...
                            <li class="nav-item">
                                <a href="<?= base_url('login'); ?>" role="button" class="btn btn-info btn-md ml-5">Sign In</a>
                            </li>
                        </ul>
                    </div>
                </nav>
        ...
        <section class="slider_section ">
            <div class="slider_bg_box">
                <img src="<?= base_url(); ?>/users/images/slider-bg.jpg" alt="">
            </div>
        ...
        <div class="container">
            <div class="box">
                <div class="arrival_bg_box">
                    <img src="<?= base_url(); ?>/users/images/arrival-bg.png" alt="">
                </div>
                <div class="row">
            ...
            <div class="row">
                <div class="col-sm-6 col-md-4 col-lg-4">
                    <div class="box">
                        ...
                        <div class="img-box">
                            <img src="<?= base_url(); ?>/users/images/p1.png" alt="">
                        </div>
                        <div class="detail-box">
                            <h5>
                                Men's Shirt
                ...
                <div class="col-sm-6 col-md-4 col-lg-4">
                    <div class="box">
                        ...
                        <div class="img-box">
                            <img src="<?= base_url(); ?>/users/images/p2.png" alt="">
                        </div>
                        <div class="detail-box">
                            <h5>
                                Men's Shirt
                ...
                <div class="col-sm-6 col-md-4 col-lg-4">
                    <div class="box">
                        ...
                        <div class="img-box">
                            <img src="<?= base_url(); ?>/users/images/p3.png" alt="">
                        </div>
                        <div class="detail-box">
                            <h5>
                                Women's Dress
                ...
                <div class="col-sm-6 col-md-4 col-lg-4">
                    <div class="box">
                        ...
                        <div class="img-box">
                            <img src="<?= base_url(); ?>/users/images/p4.png" alt="">
                        </div>
                        <div class="detail-box">
                            <h5>
                                Women's Dress
                ...
                <div class="col-sm-6 col-md-4 col-lg-4">
                    <div class="box">
                        ...
                        <div class="img-box">
                            <img src="<?= base_url(); ?>/users/images/p5.png" alt="">
                        </div>
                        <div class="detail-box">
                            <h5>
                                Women's Dress
                ...
                <div class="col-sm-6 col-md-4 col-lg-4">
                    <div class="box">
                        ...
                        <div class="img-box">
                            <img src="<?= base_url(); ?>/users/images/p6.png" alt="">
                        </div>
                        <div class="detail-box">
                            <h5>
                                Women's Dress
                ...
                <div class="col-sm-6 col-md-4 col-lg-4">
                    <div class="box">
                        ...
                        <div class="img-box">
                            <img src="<?= base_url(); ?>/users/images/p7.png" alt="">
                        </div>
                        <div class="detail-box">
                            <h5>
                                Women's Dress
                ...
                <div class="col-sm-6 col-md-4 col-lg-4">
                    <div class="box">
                        ...
                        <div class="img-box">
                            <img src="<?= base_url(); ?>/users/images/p8.png" alt="">
                        </div>
                        <div class="detail-box">
                            <h5>
                                Men's Shirt
                ...
                <div class="col-sm-6 col-md-4 col-lg-4">
                    <div class="box">
                        ...
                        <div class="img-box">
                            <img src="<?= base_url(); ?>/users/images/p9.png" alt="">
                        </div>
                        <div class="detail-box">
                            <h5>
                                Men's Shirt
                ...
                <div class="col-sm-6 col-md-4 col-lg-4">
                    <div class="box">
                        ...
                        <div class="img-box">
                            <img src="<?= base_url(); ?>/users/images/p10.png" alt="">
                        </div>
                        <div class="detail-box">
                            <h5>
                                Men's Shirt
                ...
                <div class="col-sm-6 col-md-4 col-lg-4">
                    <div class="box">
                        ...
                        <div class="img-box">
                            <img src="<?= base_url(); ?>/users/images/p11.png" alt="">
                        </div>
                        <div class="detail-box">
                            <h5>
                                Men's Shirt
                ...
                <div class="col-sm-6 col-md-4 col-lg-4">
                    <div class="box">
                        ...
                        <div class="img-box">
                            <img src="<?= base_url(); ?>/users/images/p12.png" alt="">
                        </div>
                        <div class="detail-box">
                            <h5>
                                Women's Dress
                            ...
                            <div class="img_container">
                                <div class="img-box">
                                    <div class="img_box-inner">
                                        <img src="<?= base_url(); ?>/users/images/client.jpg" alt="">
                                    </div>
                                </div>
                            </div>
                            <div class="detail-box">
